## The script bellow writes to disk the plot1.png file which is useful to answer question 1
...
##    (3) Aggregates PM25 values by year
##    (4) Writes PM2.5 by year plot in png graphic device using base plotting system
...
title(main='PM2.5 total emissions by year')
